...
{
public:
    __aicore__ inline ReduceScatter()
    {
    }
...
REDUCE_SCATTER_FUNC_DEFINE(int32_t);
REDUCE_SCATTER_FUNC_DEFINE(float16_t);
REDUCE_SCATTER_FUNC_DEFINE(bfloat16_t);
REDUCE_SCATTER_FUNC_DEFINE(float);
